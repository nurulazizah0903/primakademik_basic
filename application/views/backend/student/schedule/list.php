            ...
            <tr>
                ...
                <td class="m-1">
                        <?php
                            ...
                            $sunday_schedules = $this->db->get_where('routines', array('class_id' => $class_id, 'section_id' => $section_id, 'session_id' => active_session(), 'day' => $namahari))->result_array();
                        ...
                        ?>
                            ...
                            <button type="button" class="btn <?= ($sunday_schedule['day'] == $namahari) ? 'btn-success' : 'btn-secondary' ?> dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                ...
                                <p style="margin-bottom: 0px;"><i class="mdi mdi-clock"></i>
                                    <?php echo $sunday_schedule['time_start'].' - '.$sunday_schedule['time_finish']; ?>
                                </p>
            ...
            <tr>
                ...
                <td class="m-1">
                        ...
                        <?php
                            ...
                            $this->db->order_by('time_start', 'asc');
                        	$monday_schedule_extracurriculars = $this->db->get_where('routine_extracurricular', array('school_id' => school_id(), 'session_id' => active_session(), 'day' => $namahari))->result_array();
                        ...
                        ?>
                            ...
                            <button type="button" class="btn <?= ($monday_schedule_extracurriculars['day'] == $namahari) ? 'btn-success' : 'btn-secondary' ?> dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                ...
                                <p style="margin-bottom: 0px;"><i class="mdi mdi-clock"></i>
                                    <?php echo $monday_schedule_extracurriculars['time_start'].' - '.$monday_schedule_extracurriculars['time_finish']; ?>
                                </p>
                                <span class="caret"></span>
                                </button>
                            </div>
