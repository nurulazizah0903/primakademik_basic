...
<div class="row">
    <div class="col-12">
        <div class="card pt-0">
            <h4 class="text-center mx-0 py-2 mt-0 mb-3 px-0 text-white bg-primary"><?php echo get_phrase('create_book_issue'); ?></h4>
...
$(document).ready(function () {
  initSelect2(['#role_on_create', '#user_id_on_create', '#book_on_create']);
});
