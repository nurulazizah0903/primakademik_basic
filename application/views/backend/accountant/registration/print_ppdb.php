    ...
    <div class="page">
        ...
        <center>
            <table width="100%">
                ...
                <tr>
                    <td align="center"><b><div class="upper"><?= get_current_school_data("name") ?><br>"<?php echo get_phrase('TERAKREDITASI A'); ?>"</b></div></td>
                </tr>
                <tr>
        ...
        <div class="horizontal_center"></div>
            <table width="100%" style="font-size: 15px;">
                <tr>
                    <td>
                        <center><b><p><div class="upper"><?php echo get_phrase('SYARAT_&_KETENTUAN_PENGUNDURAN_DIRI'); ?></div></p></b></center>
                        <ol>
                            ...
                            <li>Siswa yang mengundurkan diri :</li><br>
                                <ol type="a">
                            ...
                            <li>Pengunduran diri khusus pendaftar inden angsur yang belum lunas dihitung sebagaimana poin 3 tanpa dikurangi biaya perlengkapan.</li><br><br><br>
                        </ol>
                    </td>
                    <td>
                        ...
                        <ol>
                            ...
                            <li>Alamat Sekolah :<br>
                                Jl. Sidotopo Wetan Baru No. 37<br>
                                Narahubung 1 :  0852 3047 3839<br>
                                Narahubung 2 :  0878 7913 6979<br>
