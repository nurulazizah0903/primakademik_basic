<?php 
$school_id = school_id();
if(isset($mean_id) && $mean_id != ''){
$this->db->where('mean_id', $mean_id);
}
if(isset($date) && $date != ''){
                    ...
                    <td>
                        <div class="dropdown text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <?php /* <a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?php echo route('mean_issue/return/'.$mean_issue['id']); ?>', showAllBookDeadline )"><?php echo get_phrase('mean_already_return'); ?></a> */?>
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?php echo route('mean_issue/delete/'.$mean_issue['id']); ?>', showAllMeanDeadline )"><?php echo get_phrase('delete'); ?></a>
                            </div>
                        </div>
                    </td>
                </tr>
...
<script>
    ...
    var form = $(this);
    ajaxSubmit(e, form, showAllMeanDeadline);
    });
</script>