...
<form action="<?php echo site_url('addons/courses/lessons/'.$param2.'/edit'.'/'.$param1); ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <select class="form-control select2" data-toggle="select2" name="lesson_type" id="lesson_type" required onchange="show_lesson_type_form(this.value)">
            ...
            <option value="video-url" <?php if($lesson_details['attachment_type'] == 'url' || $lesson_details['attachment_type'] == '') echo 'selected'; ?>><?php echo get_phrase('online_video'); ?></option>
            ...
            <option value="other-img" <?php if($lesson_details['attachment_type'] == 'img') echo 'selected'; ?>><?php echo get_phrase('file_dokumen_lainnya'); ?></option>
        </select>
    </div>
    ...
    <div class="<?php if($lesson_details['lesson_type'] != 'video'):?> dv_none <?php endif; ?>" id="video">
        ...
        <div class="<?php if(strtolower($lesson_details['video_type']) == 'vimeo' || strtolower($lesson_details['video_type']) == 'youtube'):?>  <?php else: ?> dv_none <?php endif; ?>" id = "youtube_vimeo">
            ...
            <div class="form-group">
                ...
                <label class="form-label mt-2 dv_none" id = "perloader"><i class="mdi mdi-spin mdi-loading">&nbsp;</i><?php echo get_phrase('analyzing_the_url'); ?></label>
                <label class="form-label mt-2 dv_none text-danger" id = "invalid_url"><?php echo get_phrase('invalid_url').'. '.get_phrase('your_video_source_has_to_be_either_youtube_or_vimeo'); ?></label>
            </div>
