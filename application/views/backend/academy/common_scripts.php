<script type="text/javascript">
    ...
    function course_activity(course_id){
        ...
        success : function() {
            ...
            toastr.success('<?php echo get_phrase('course_data_updated_successfully');?>');
            $.ajax({
    ...
    function get_subject_section(){
        var section_id = $('#section_id').val();
        $.ajax({
            url: "<?php echo site_url('addons/courses/get_subject_by_section/'); ?>"+section_id,
            success: function(response){
                $('#subject_id').html(response);
            }
        });
    ...
    function get_section(){
        var class_id = $('#class_id').val();
        $.ajax({
            url: "<?php echo site_url('addons/courses/get_section_by_class/'); ?>"+class_id,
            success: function(response){
