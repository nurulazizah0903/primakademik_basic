<form method="POST" class="d-block ajaxForm" action="<?php echo route('awards/create'); ?>">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <label for="point"><?php echo get_phrase('point'); ?></label>
            <input type="number" class="form-control" id="point" name = "point" required>
        </div>
        <div class="form-group  col-md-12">
            <button class="btn btn-block btn-primary" type="submit"><?php echo get_phrase('create_awards'); ?></button>
        </div>
    </div>
</form>
