            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="page-title">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?php echo site_url('modal/popup/student_extracurricular/create'); ?>', '<?php echo get_phrase('add_student_extracurricular'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_student_extracurricular'); ?></button>
                    </h4>
                </div> <!-- end card body-->
            </div> <!-- end card -->
        </div><!-- end col-->
