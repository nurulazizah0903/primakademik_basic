...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('knowledge_base/excel_base'); ?>" enctype="multipart/form-data">
<input type="hidden" name="teacher_id" value="<?= $teacher_id ?>">
    <div class="row justify-content-md-center">
        <div class="col-md-8 mt-4">
            <div class="row">
                <div class="col-12">
                    <a href="<?php echo base_url('assets/csv_file/new_template/Tempalte Dasar Kompetensi.csv'); ?>" class="btn btn-success btn-sm mb-1" download><?php echo get_phrase('generate_csv_file'); ?><i class="mdi mdi-download"></i></a>
                </div>
            </div>
            <br>
