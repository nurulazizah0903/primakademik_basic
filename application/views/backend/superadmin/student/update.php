    ...
    <div class="col-12">
        <div class="card pt-0">
            ...
            <form method="POST" class="col-12 d-block ajaxForm" action="<?php echo route('student/updated/'.$student_id.'/'.$users['id']); ?>" id = "student_update_form" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-lg-6 ">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_un'); ?></h5>
                                <input type="text" id="nomor_un" name="nomor_un" value="<?php echo $student['nomor_un']; ?>" class="form-control" placeholder="<?php echo get_phrase('nomor_un'); ?>">
                ...
                <div class="row">
                    <div class="col-lg-6 ">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_ijazah'); ?></h5>
                            <input type="text" id="nomor_ijazah" name="nomor_ijazah" value="<?php echo $student['nomor_ijazah']; ?>" class="form-control" placeholder="<?php echo get_phrase('nomor_ijazah'); ?>" >
                        
                    </div> <!-- end col-->

                    <div class="col-lg-6 ">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_skhun'); ?></h5>
                            <input type="text" id="nomor_skhun" name="nomor_skhun" value="<?php echo $student['nomor_skhun']; ?>" class="form-control" placeholder="<?php echo get_phrase('nomor_skhun'); ?>">
                ...
                <div class="row">
                    <div class="col-lg-6 ">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('school_before'); ?></h5>
                            <input type="text" id="school_before" name="school_before" value="<?php echo $student['school_before']; ?>" class="form-control" placeholder="<?php echo get_phrase('school_before'); ?>" >
                        
                    </div> <!-- end col-->
                    <div class="col-lg-6 ">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('NIS'); ?> <font style="color:red;">*</font></h5>
                            <input type="text" id="NIS" name="nis" value="<?php echo $student['NIS']; ?>" class="form-control" placeholder="NIS" required>
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('nik'); ?> </h5>
                                    <input type="number" id="nik" name="nik" class="form-control" value="<?php echo $this->user_model->get_user_details($student['user_id'], 'nik'); ?>" >
                            </div> <!-- end col-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('birthday'); ?> </h5>
                                    <input type="text" class="form-control date" id="birthdatepicker" data-toggle="date-picker" data-single-date-picker="true" name = "birthday"  placeholder="<?php echo $users['brithday']; ?>" >
                            </div> <!-- end col-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('email'); ?> <font style="color:red;">*</font></h5>
                                    <input type="text" class="form-control" id="email" name="email" value="<?php echo $this->user_model->get_user_details($student['user_id'], 'email'); ?>" placeholder="email" required>
                            </div> <!-- end col-->

                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('number_va'); ?></h5>
                                    <input type="text" class="form-control" id="va" name="va" value="<?php echo $student['va']; ?>" placeholder="Virtual Account">
                            </div> <!-- end col-->
                        </div> <!-- end row --><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('class_room'); ?> </h5>
                                    <select name="room_id" id="room_id" class="form-control select2"  data-toggle="select2" >
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('province'); ?> </h5>
                                    <select name="student_province_id" id="student_province_id" class="form-control select2" data-toggle = "select2"  onchange="districtWiseSection(this.value)">
                            ...
                            <div class="col-lg-3">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('district'); ?> </h5>
                                    <select name="student_district_id" id="district_id" class="form-control select2" data-toggle = "select2" onchange="districtsWiseSection(this.value)">
                            ...
                            <div class="col-lg-3">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('districts'); ?> </h5>
                                    <select name="student_districts_id" id="districts_id" class="form-control select2" data-toggle = "select2" onchange="wardWiseSection(this.value), postcodeWiseSection(this.value)">
                            ...
                            <div class="col-lg-3">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('ward'); ?> </h5>
                                    <select name="student_ward_id" id="ward_id" class="form-control select2" data-toggle = "select2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('postcode'); ?> </h5>
                                    <select name="student_postcode_id" id="postcode_id" class="form-control select2" data-toggle = "select2" >
                    ...
                    <div class="tab-pane fade show" id="parent_info" role="tabpanel" aria-labelledby="parent-tab"><br><br>
                        ...
                        <div class="tab-pane fade show" id="guardian_info" role="tabpanel" aria-labelledby="guardian-tab"><br><br>
                            <h5 style="font-weight: bold;"><?php echo get_phrase('guardian'); ?> </h5>
                            <div class="col-md-9">
                                    <select id="guardian_id" name="guardian_id" class="form-control select2"  data-toggle="select2" >
                        ...
                        <h5 style="font-weight: bold;"><?php echo get_phrase('upload_skhun'); ?></h5>
                            <div class="col-md-9 custom-file-upload">
                                <input type="file" id="skhun" class="form-control" name="skhun">
                            </div><br><br><br>
                            
                        <h5 style="font-weight: bold;"><?php echo get_phrase('upload_ijazah'); ?></h5>
                            <div class="col-md-9 custom-file-upload">
                                <input type="file" id="ijazah" class="form-control" name="ijazah">
                            </div><br><br><br>
                            
                        <h5 style="font-weight: bold;"><?php echo get_phrase('upload_rapor'); ?></h5>
                            <div class="col-md-9 custom-file-upload">
                                <input type="file" id="rapor_semester" class="form-control" name="rapor_semester">
                            </div><br><br><br>
                    ...
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('weight'); ?></h5>
                                <input type="text" id="weight" name="weight" class="form-control" value="<?php echo $student['weight']; ?>">
                            </div><br><br><br>
                    </div>
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('height'); ?></h5>
                                <input type="text" id="height" name="height" class="form-control" value="<?php echo $student['height']; ?>">
                            </div><br><br><br>
                    </div>
                    <div class="row">    
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('mileage'); ?></h5>
                                <input type="text" id="mileage" name="mileage" class="form-control" value="<?php echo $student['mileage']; ?>">
                            </div><br><br><br>
                    </div>
                    <div class="row">        
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('traveling_time'); ?></h5>
                                <input type="text" id="traveling_time" name="traveling_time" class="form-control" value="<?php echo $student['traveling_time']; ?>" >
                            </div><br><br><br>
                    </div>
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('child_of'); ?></h5>
                                <input type="text" id="child_of" name="child_of" class="form-control" value="<?php echo $student['child_of']; ?>" >
                            </div><br><br><br>
                    </div>
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('number_of_siblings'); ?></h5>
                                <input type="text" id="number_of_siblings" name="number_of_siblings" class="form-control" value="<?php echo $student['number_of_siblings']; ?>" >
                            </div><br><br>
                    </div>
                    </div>
