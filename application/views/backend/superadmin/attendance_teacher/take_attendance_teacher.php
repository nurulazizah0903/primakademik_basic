...
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo route('attendance_teacher/take_attendance_teacher'); ?>" style="min-width: 300px; max-width: 400px;">
...
<script>
    ...
    function getStudentList() {
        ...
        if(date != ''){
            $.ajax({
                type : 'POST',
                url : '<?php echo route('attendance_teacher/teacher/'); ?>',
                data: {date : date},
                success : function(response) {
