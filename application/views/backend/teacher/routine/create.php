<form method="POST" class="d-block ajaxForm" action="<?php echo route('routine/create'); ?>" style="min-width: 300px;">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-9">
            <select name="section_id" id = "section_id_on_routine_creation" class="form-control select2" data-toggle="select2"  required onchange="classWiseSubjectForRoutineCreate(this.value)">
