...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('invoice/payment/'.$param1); ?>">
    <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <select name="class_id" id="class_id_on_create" class="form-control select2" data-toggle="select2" onchange="classWiseStudentOnCreate(this.value)" disabled >
        ...
        <div class="form-group col-md-4">
            ...
            <select name="section_id_on_create" id="section_id_on_create" class="form-control select2" data-toggle="select2" disabled >
        ...
        <div class="form-group col-md-4">
            ...
            <div id = "student_content">
                <select name="student_id" id="student_id_on_create" class="form-control select2" data-toggle="select2" disabled >
        ...
        <div class="form-group col-md-6"> 
            ...
            <input type="text" class="form-control" id="invoice_id" name = "invoice_id" value="<?php echo $invoice_details['title']; ?>" disabled >
        </div> 
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="payment_type_id" name = "payment_type_id" value="<?php echo $payment_types['name']; ?>" disabled >
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="total_amount" name = "total_amount" value="<?php echo $total_amount22; ?>" style="font-weight: bold; background-color: #d1e6d6;" disabled>
        </div>  
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="saving_total" name="saving_total" value="<?PHP echo $savings['total']; ?>" disabled>
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="total_amount1" name = "total_amount1" value="<?php echo $total_amount3; ?>" style="font-weight: bold; background-color: #d1e6d6;" disabled>
        </div> 

        <div class="form-group col-md-4">
            <label for="paid_amount"><?php echo get_phrase('paid_amount').' ('.currency_code_and_symbol('code').')'; ?></label>
            <input type="text" class="form-control" autocomplete="off" id="paid_amount" name = "paid_amount" value="<?php echo $total_amount3; ?>" >
        </div>

        <div class="form-group col-md-8">
            <label for="finances_file"><?php echo get_phrase('upload_bukti'); ?></label>
            <div class="custom-file-upload">
                <input type="file" class="form-control" id="finances_file" name = "finances_file" >
            </div>
        </div>  
        <?PHP
            }
        ...
        <div class="form-group col-md-4">
            <label for="paid_amount"><?php echo get_phrase('paid_amount').' ('.currency_code_and_symbol('code').')'; ?></label>
            <input type="text" class="form-control" autocomplete="off" id="paid_amount" name = "paid_amount" value="<?php echo $total_amount22; ?>" >
        </div>
