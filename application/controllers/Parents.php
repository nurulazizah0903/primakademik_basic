...
class Parents extends CI_Controller {
	...
	public function dashboard(){
		...
		// $this->load->view('backend/parent/dashboard/index', $page_data);
	}
	...
	public function announcement($param1 = '', $param2 = '', $param3 = ''){
		...
		if(empty($param1)){
			$page_data['folder_name'] = 'dashboard';
			$page_data['page_title'] = 'dashboard';
			$this->load->view('backend/parent/dashboard/announcement', $page_data);
		}
	}
	//END SYLLABUS section
	...
	public function routine($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/routine/index', $page_data);
		}
	}
	...
	public function attendance($param1 = '', $param2 = '', $param3 = ''){
		...
		if($param1 == 'filter'){
			...
			$page_data['class_id'] = $student_data['class_id'];
			$page_data['section_id'] = $student_data['section_id'];
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/attendance/index', $page_data);
		}
	}
	...
	public function event_calendar($param1 = '', $param2 = ''){
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/event_calendar/index', $page_data);
		}
	}
	...
	public function mark($param1 = '', $param2 = ''){
		...
		if($param1 == 'list'){
			$page_data['mark_type'] = $this->input->post('mark_type');
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/mark/index', $page_data);
		}
	}
	//END MARKS sesction
	...
	public function profile($param1 = "", $param2 = "") {
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/profile/index', $page_data);
		}
	}
	//MANAGE PROFILE ENDS
	...
	public function raport($param1 = '', $param2 = '', $param3 = ''){
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/raport/index', $page_data);
		}
	}
	...
	public function child_assignment($param1 = '', $param2 = '', $param3 = ''){
		...
		if(empty($param1)){
			...
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/child_assignment/index', $page_data);
		}
	}
	...
	public function invoice($param1 = "", $param2 = "") {
		...
		if ($param1 == 'payment') {
			...
			$this->session->set_flashdata('idSiswa', $this->input->post('id_siswa'));
			return redirect('parents/invoice');
		}
		// showing the index file
		if(empty($param1)){
			$page_data['folder_name'] = 'invoice';
			...
			$first_day_of_month = "1 ".date("M")." ".date("Y").' 00:00:00';
      		...
      		$page_data['date_to']     = strtotime($last_day_of_month);
			$this->load->view('backend/index', $page_data);
			// $this->load->view('backend/parent/invoice/index', $page_data);	
		}
