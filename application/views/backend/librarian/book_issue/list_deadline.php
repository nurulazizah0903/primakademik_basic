                    ...
                    <td>
                        <div class="dropdown text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <?php /* <a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?php echo route('book_issue/return/'.$book_issue['id']); ?>', showAllBookDeadline )"><?php echo get_phrase('book_already_return'); ?></a> */?>
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?php echo route('book_issue/delete/'.$book_issue['id']); ?>', showAllBookDeadline )"><?php echo get_phrase('delete'); ?></a>
                            </div>
                        </div>
                    </td>
                </tr>
...
<script>
    ...
    var form = $(this);
    ajaxSubmit(e, form, showAllBookDeadline);
    });
</script>