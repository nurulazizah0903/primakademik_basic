...
<div class="table-responsive-sm row col-md-12" style="padding-right: 0px;">
    <table id="datatable" class="table table-bordered table-centered mb-0">
        ...
        <tbody>
            <?php $enrols = $this->db->get_where('enrols', array('class_id' => $class_id, 'room_id' => $room_id, 'section_id' => $section_id, 'school_id' => $school_id, 'session' => active_session()))->result_array(); ?>
