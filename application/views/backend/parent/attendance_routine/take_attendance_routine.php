...
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo route('attendance_routine/take_attendance_routine'); ?>" style="min-width: 300px; max-width: 400px;">
    ...
    <div class="form-group row">
        <div class="col-md-12" id = "section_content_2">
            ...
            <select name="section_id" id="section_id_on_taking_attendance" class="form-control select2" data-toggle="select2" required onchange="classWiseSubjectOnTakingAttendance(this.value)">
...
<script>
    ...
    $('document').ready(function(){
        initSelect2(['#class_id_on_taking_attendance', '#section_id_on_taking_attendance', '#subject_id_on_taking_attendance']);
