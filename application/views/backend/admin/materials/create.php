<form method="POST" class="d-block ajaxForm" action="<?php echo route('materials/create'); ?>" enctype="multipart/form-data">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            ...
            <select class="form-control select2" data-toggle = "select2" id="section_id_on_create" name="section_id" onchange="classWiseSubjectOnCreate(this.value), sectionWiseClassroomsOnCreate(this.value)" required>
