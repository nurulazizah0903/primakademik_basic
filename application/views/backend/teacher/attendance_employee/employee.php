...
<div class="table-responsive-sm row col-md-12" style="padding-right: 0px;">
    <table class="table table-bordered table-centered mb-0">
        ...
        <tbody>
        <?php $employees = $this->db->get_where('users', array('school_id' => $school_id, 'role' => $role))->result_array();?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="custom-control custom-radio">
                            <?php $update_attendance = $this->db->get_where('daily_attendance_employee', array('timestamp' => $attendance_date, 'session_id' => active_session(), 'school_id' => $school_id, 'user_id' => $employee['id'])); ?>
                            ...
                            <?php else: ?>
                                <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="1" class="present" required> <?php echo get_phrase('present'); ?> <br/>
                                ...
                                <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="0" class="absent" checked required> <?php echo get_phrase('absent'); ?>
