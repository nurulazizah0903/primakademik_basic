...
if(isset($keyword) && $keyword != ''){
  ...
  $this->db->where('enrols.session !=', NULL);
        ...
        <tbody>
          <?php foreach($enrols as $enroll){
            ...
            <tr>
              ...
              <td>
                <a href="<?php echo route('student/edit/'.$student['id']); ?>"><button type="button" class="btn btn-icon btn-warning btn-sm" style="margin-right:3px;" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('edit'); ?>"> <i class="mdi mdi-pencil"></i></button></a>
                <a href="javascript:void(0);" type="button" class="btn btn-icon btn-info btn-sm" onclick="largeModal('<?php echo site_url('modal/popup/student_card/template/'.$student['id'])?>', '<?php echo $this->db->get_where('schools', array('id' => $school_id))->row('name'); ?>')"><i class="mdi mdi-card-text-outline"></i></a>
                <!-- <a href="<?php echo route('student_card/'.$student['id']); ?>"><button type="button" class="btn btn-icon btn-info btn-sm" style="margin-right:3px;" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('print'); ?>"> <i class="mdi mdi-card-text-outline"></i></button></a> -->
