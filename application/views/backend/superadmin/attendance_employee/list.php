            ...
            <thead class="thead-dark">
                <tr style="font-size: 10px;">
                    ...
                    <?php
                        ...
                        ?>
                        <th><a type="button" onclick="largeModal('<?php echo site_url('modal/popup/attendance_employee/modal_add/'.$tanggal.'/'.$role)?>', '<?= get_phrase('take_attendance_employee'); ?>')" data-toggle="tooltip" data-placement="top" title=""><?php echo $i; ?></a></th>
                    <?php endfor; ?>
                </tr>
            </thead>
            <tbody>
