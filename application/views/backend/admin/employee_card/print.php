...
<body>
    ...
    <fieldset class="fieldset-auto-width">
        <div class="info">
            <div class="school"><?=get_phrase('employee_card');?></div>
        ...
        <table class="name">
            <tr style="">
                <td colspan="3" style="text-align: center; font-size: 8px; font-weight: bold; text-transform: uppercase;"><?php echo $employee['name'] ?></td>
            ...
            <tr>
                <td colspan="3" style="text-align: center; text-transform: uppercase;font-size: 8px;"><?php echo get_phrase($employee['gender']) ?></td>
            </tr>
            <tr>
