...
<form method="POST" class="col-md-12 ajaxForm" action="<?php echo route('student/create_excel_studentsonschool'); ?>" id = "student_admission_form" enctype="multipart/form-data">
        ...
        <div class="col-md-8 mt-4">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- <button href="#" class="btn btn-dark btn-sm mb-1 mdi mdi-eye-outline" onclick="rightModal('<?php echo site_url('modal/popup/student/csv_preview'); ?>', 'CSV Format');" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('preview_csv_format'); ?>"></button> -->
                </div>
            </div>
            <br>
