                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 mb-1">
                        <select name="class" id="class_id" class="form-control select2" data-toggle = "select2" required onchange="classWiseSection(this.value)">
                            ...
                            // $classes = $this->db->get_where('teacher_permissions', array('teacher_id' => $teacher_id))->result_array();
                            $classes = $this->db->get_where('classes', array('school_id' => school_id()))->result_array();
                            foreach($classes as $class){
                                ?>
                                <option value="<?php echo $class['id']; ?>"><?php echo $class['name']; ?></option>
                                <!-- <option value="<?php echo $class['class_id']; ?>"><?php echo $this->db->get_where('classes', array('id' => $class['class_id']))->row('name'); ?> -->
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-md-4 mb-1">
