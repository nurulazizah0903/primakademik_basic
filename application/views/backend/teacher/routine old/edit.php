        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select name="starting_hour" id = "starting_hour_on_routine_creation" class="form-control" required>
                    ...
                    <?php for($i = 0; $i <= 23; $i++){ ?>
                        <option value="<?php echo $i; ?>" <?php if($routine['starting_hour'] == $i) echo 'selected'; ?>><?php echo $i; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select name="ending_hour" id = "ending_hour_on_routine_creation" class="form-control" required>
                    ...
                    <?php for($i = 0; $i <= 23; $i++){ ?>
                                <option value="<?php echo $i; ?>" <?php if($routine['ending_hour'] == $i) echo 'selected'; ?>><?php echo $i; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
