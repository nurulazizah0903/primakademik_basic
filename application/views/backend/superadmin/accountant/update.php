<?php 
$school_id = school_id(); 
$users = $this->db->get_where('users', array('id' => $accountant_id))->result_array();
foreach($users as $user):
$job = $this->db->get_where('job_management', array('user_id' => $user['id']))->result_array();
$job_accountant = $this->db->get_where('job_management', array('user_id' => $accountant_id, 'status' => 1))->row_array();
?>
<!--title-->
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">
                <i class="mdi mdi-update title_icon"></i> <?php echo get_phrase('accountant_update_form'); ?>
            </h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card pt-0">
            <h4 class="text-center mx-0 py-2 mt-0 mb-3 px-0 text-white bg-primary"><?php echo get_phrase('update_accountant_information'); ?></h4>
            <form method="POST" class="col-12 d-block ajaxForm" action="<?php echo route('accountant/update_employee/'.$accountant_id); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('start_date'); ?> <font style="color:red;">*</font></h5>
                    <input type="text" class="form-control" name = "start_date" value="<?php echo date('D, d/M/Y', strtotime($job_accountant['start_date'])); ?>" disabled>
            </div> <!-- end col-->

            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('finish_date'); ?> <font style="color:red;">*</font></h5>
                    <input type="text" class="form-control" name = "finish_date" value="--" disabled>
            </div> <!-- end col-->
        </div> <!-- end row --><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('birthday'); ?> <font style="color:red;">*</font></h5>
                            <input type="text" class="form-control date" id="birthdatepicker" data-toggle="date-picker" data-single-date-picker="true" name = "birthday"   value="<?php echo date('m/d/Y'), $user['birthday']; ?>" required>
                    </div> <!-- end col-->
