        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <?php /*  
                    <a href="<?php echo base_url().'superadmin/finance/finance_va/'; ?>" >  
                      <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_payment'); ?></button>
                    </a>
                    */ ?>
                  </h4>
            </div> <!-- end card body-->
