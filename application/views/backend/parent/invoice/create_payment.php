...
?> 
<form method="POST" id="formElem" class="d-block ajaxForm" action="<?php echo route('invoice/payment/'.$param1); ?>">
    <input type="hidden" name="id_siswa" value="<?= $invoice_details['student_id']; ?>">
    <div class="form-row">
        ...
        <?PHP 
        $total_amount3 = 0;  $total_amount22 = 0;
        if(isset($savings)) 
        {  ?> 
        <div class="form-group col-md-6">
        ...
        <div class="form-group col-md-12">
            ...
            <input type="text" class="form-control" id="total" name = "total" value="<?php echo $total_amount3; ?>" style="font-weight: bold; background-color: #d1e6d6;" required disabled>
        </div> 

        <input type="hidden" class="form-control" id="total_amount1" name = "total_amount1" value="<?php echo $total_amount3; ?>" >
        ...
        <input type="hidden" class="form-control" id="total_amount1" name = "total_amount1" value="<?php echo $total_amount3; ?>" >
        <input type="hidden" class="form-control" id="total_amount22" name = "total_amount22" value="<?php echo $total_amount22; ?>" >
        ...
        <input type="hidden" class="form-control" id="total_amount1" name = "total_amount1" value="<?php echo $total_amount22; ?>" >
