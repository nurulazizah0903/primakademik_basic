                ...
                <tr>
					...
					<div class="dropdown text-center">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<!-- item-->
							<a href="javascript:void(0);" class="dropdown-item" onclick="largeModal('<?php echo site_url('modal/popup/question_bank/edit/'.$question_bank['id'])?>', '<?php echo get_phrase('update_question_bank'); ?>');"><?php echo get_phrase('edit'); ?></a>
							<!-- item-->
