    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="showAjaxModal('<?php echo site_url('modal/popup/noticeboard/create'); ?>', '<?php echo get_phrase('add_new_notice'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_new_notice'); ?></button>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
