				...
				<td>
					<div class="dropdown text-center">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<!-- item-->
							<a href="javascript:void(0);" class="dropdown-item" onclick="showAjaxModal('<?php echo site_url('modal/popup/department/edit/'.$department['id'])?>', '<?php echo get_phrase('update_department'); ?>');"><?php echo get_phrase('edit'); ?></a>
							<!-- item-->
