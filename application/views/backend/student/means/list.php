            ...
            <td>
              <div class="dropdown text-center">
      					...
      					<div class="dropdown-menu dropdown-menu-right">
      						<!-- item-->
      						<a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/means/edit/'.$mean['id'])?>', '<?php echo get_phrase('update_infrastructure'); ?>');"><?php echo get_phrase('edit'); ?></a>
      						<!-- item-->
      						<a href="javascript:void(0);" class="dropdown-item" onclick="confirmModal('<?php echo route('means/delete/'.$mean['id']); ?>', showAllInfrastructure )"><?php echo get_phrase('delete'); ?></a>
      					</div>
      				</div>
            </td>
          </tr>
