<?php $question = $this->db->get_where('exam_questions', array('id' => $param1))->row_array(); ?>
<form method="POST" class="d-block ajaxForm" action="<?php echo site_url('addons/exam/questions/update/'.$param1); ?>">
    <div class="form-row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-2">
                    <input type="checkbox" id="correct_choices" 
                        <?php
                            $str_explode = explode(";", $question['correct_choices']);
