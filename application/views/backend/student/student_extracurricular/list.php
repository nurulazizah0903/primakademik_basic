              ...
              <td>
                <div class="dropdown text-center">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/student_extracurricular/update/'.$student['id'])?>', '<?php echo get_phrase('update_student_extracurricular_information'); ?>');"><?php echo get_phrase('edit'); ?></a>
                  </div>
                </div>
              </td>
            </tr>
