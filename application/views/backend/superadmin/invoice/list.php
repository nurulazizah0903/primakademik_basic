        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <?PHP }  ?>    
                    <?PHP /*   } else {?>
                        <button type="button" class="btn btn-sm btn-icon btn-rounded btn-outline-secondary dropdown-toggle arrow-none card-drop" onclick="javascript:window.open('<?php echo route('invoice/invoice/'.$invoice['id']); ?>', '_blank');"><i class="mdi mdi-printer-settings"></i></button> 
                    <?php } */?>    
                    </div> 																	
                </td>
				<td>
