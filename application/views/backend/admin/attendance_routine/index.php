    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <!-- <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="largeModal('<?php echo site_url('modal/popup/attendance_routine/take_attendance_routine'); ?>', '<?php echo get_phrase('take_attendance_routine'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('take_attendance_routine'); ?></button> -->
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
