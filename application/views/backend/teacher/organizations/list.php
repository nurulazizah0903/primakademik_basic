				...
				<!-- <td>
					<div class="dropdown text-center">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<!-- item-->
							<a href="javascript:void(0);" class="dropdown-item" onclick="showAjaxModal('<?php echo site_url('modal/popup/organizations/edit/'.$organization['id'])?>', '<?php echo get_phrase('update_organizations'); ?>');"><?php echo get_phrase('edit'); ?></a>
							<!-- item-->
