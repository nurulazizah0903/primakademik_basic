...
<?php foreach($schools as $school){ ?>
  <form method="POST" class="d-block ajaxForm" action="<?php echo site_url('addons/multischool/update/'.$param1); ?>">
    <div class="form-row">
      ...
      <div class="form-group col-md-12">
        <label for="name"><?php echo get_phrase('npsn'); ?></label>
        <input type="text" class="form-control" id="npsn" name = "npsn" value="<?php echo $school['npsn']; ?>" required>
        <!-- <small id="name_help" class="form-text text-muted"><?php echo get_phrase('provide_school_name'); ?></small> -->
      </div>

      <div class="form-group col-md-12">
        <label for="nss"><?php echo get_phrase('nss'); ?></label>
        <input type="text" class="form-control" id="nss" name = "nss" value="<?php echo $school['nss']; ?>" required>
        <!-- <small id="name_help" class="form-text text-muted"><?php echo get_phrase('provide_school_name'); ?></small> -->
      </div>

      <div class="form-group col-md-12">
        <label for="longitudinal"><?php echo get_phrase('longitudinal'); ?></label>
        <input type="text" class="form-control" id="longitudinal" name = "longitudinal" value="<?php echo $school['longitudinal']; ?>" required>
        <!-- <small id="name_help" class="form-text text-muted"><?php echo get_phrase('provide_school_name'); ?></small> -->
      </div>
