				...
				<td>
					<div class="dropdown text-center">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<!-- item-->
							<a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/mistakes/edit/'.$mistake['id'])?>', '<?php echo get_phrase('update_mistakes'); ?>');"><?php echo get_phrase('edit'); ?></a>
							<!-- item-->
