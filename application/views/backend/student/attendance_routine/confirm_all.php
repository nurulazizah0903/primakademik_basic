...
?>
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo route('attendance_routine/confirm_all/'.$student_data['student_id']); ?>" style="min-width: 300px; max-width: 400px;">
    <div class="form-group row">
        <div class="col-md-12">
            ...
            <select name="subject_id" id = "subject_id_on_taking_attendance" class="form-control select2" data-toggle="select2"  required>
                ...
                <?php
                $subjects = $this->db->get_where('subjects', array('class_id' => $student_data['class_id'], 'section_id' => $student_data['section_id'], 'school_id' => school_id()))->result_array();
...
<script>
    ...
    $('document').ready(function(){
        initSelect2(['#subject_id_on_taking_attendance', '#year_on_taking_attendance', '#month_on_taking_attendance']);
