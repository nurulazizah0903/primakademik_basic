<form method="POST" class="d-block ajaxForm" action="<?php echo route('guardian/create'); ?>">
    <div class="form-row">
        ...
        <div class="form-group col-md-12">
            <label for="email"><?php echo get_phrase('email'); ?>/<?php echo get_phrase('phone'); ?></label>
        ...
        <div class="form-group  col-md-12">
            <button class="btn btn-block btn-primary" type="submit"><?php echo get_phrase('create_guardian'); ?></button>
        </div>
    </div>
</form>
...
$(".ajaxForm").submit(function(e) {
    var form = $(this);
    ajaxSubmit2(e, form, showAllGuardians);
});
</script>
