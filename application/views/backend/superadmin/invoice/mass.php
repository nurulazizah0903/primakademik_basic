<form method="POST" class="d-block ajaxForm" action="<?php echo route('invoice/mass'); ?> " id="form1">
    <div class="form-row">
        ...
        <div class="form-group  col-md-6">
            ...
            <select name="section_id_on_create" id = "section_id_on_create" class="form-control select2" data-toggle="select2" required>
        ...
        <div class="form-group col-md-8">
            ...
            <select name="payment_type" id="payment_type" class="form-control select2" data-toggle = "select2"  required onchange="show(this.value)">
                ...
                <?php $payment_types = $this->crud_model->payment_type_view()->result_array(); ?>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" id="total_amount2" name="total_amount2" class="form-control"  onkeyup="jumlahkan()"  readonly/>
        </div>
        
        <div class="form-group col-md-4">
            <label for="tax"><?php echo get_phrase('Pajak').' (%)'; ?></label>
            <input type="text" id="tax" name="tax" class="form-control"  value="0"  onkeyup="jumlahkan()" required/>
        </div>
        <div class="form-group col-md-4">
            <label for="tax2"><?php echo get_phrase('Biaya lain-lain').' ('.currency_code_and_symbol('code').')'; ?></label>
            <input type="text" id="tax2" name="tax2" class="form-control" value="0"  onkeyup="jumlahkan()" required/>
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-3">
            ...
            <select name="label" id="label" class="form-control select2" data-toggle ="select2"  onchange="tampilkan2(this.value)" required>
...
$(document).ready(function () {
    initSelect2(['#class_id_on_create', '#section_id_on_create', '#status',  '#label', '#kategori', '#tampil', '#year', '#year2',  '#kategori', '#tampil', '#year', '#year2', '#payment_type']);
});
