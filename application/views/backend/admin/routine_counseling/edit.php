...
<div class="form-group row mb-3">
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-9">
        <select name="section_id" id="section_id_on_modal" class="form-control select2" data-toggle = "select2" required onchange="classWiseStudent(this.value), sectionWiseClassroomsOnCreate(this.value)">
    ...
    <div class="form-group row mb-3">
        ...
        <div class="col-md-9">
            <select name="room_id" id="room_id_on_modal" class="form-control select2" data-toggle = "select2" required>
                    ...
                    <?php
                    $class_rooms = $this->db->get_where('class_rooms', array('id' => $routine_counseling_details['room_id']))->result_array();
