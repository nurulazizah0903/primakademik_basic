...
$employee_detail = $this->db->get_where('users', array('id' => $param1))->row_array();
$employee_status = $this->db->get_where('employee_status', array('id' => $employee_detail['employee_status_id']))->row_array(); 
$job = $this->db->get_where('job_management', array('user_id' => $param1))->result_array();
$job_teacher = $this->db->get_where('job_management', array('user_id' => $param1, 'status' => 1))->row_array();
?>
<div class="h-100">
                ...
                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table table-centered mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('employee_status'); ?>:</td>
                            ...
                            <?php if ($employee_detail['role'] == 'teacher') { ?>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('mengajar_mapel'); ?>:</td>
                                <td><ul>
                                <?php 
                                $teachers = $this->db->get_where('teachers', array('user_id' => $employee_detail['id']))->row_array();
                                $subjects = $this->db->get_where('subjects', array('teacher_id' => $teachers['id']))->result_array();
