...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('mean_issue/update/'.$param1); ?>">
  ...
  <div class="form-group row mb-3">
    ...
    <div class="col-md-9">
      <input type="text" class="form-control date" id="return_date" data-toggle="date-picker" data-single-date-picker="true" name = "return_date" value="<?php echo date('m/d/Y', $mean_issue_details['return_date']); ?>" required>
    </div>
  </div>
