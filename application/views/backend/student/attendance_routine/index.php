    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <!-- <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="rightModal('<?php echo site_url('modal/popup/attendance_routine/confirm_all'); ?>', '<?php echo get_phrase('attendance_confirm'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('attendance_confirm'); ?></button> -->
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
...
$('document').ready(function(){
  initSelect2(['#month', '#year', '#class_id', '#section_id', '#subject_id']);
});
