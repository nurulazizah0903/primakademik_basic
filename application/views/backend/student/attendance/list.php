            ...
            <?php for ($i = 1; $i <= $number_of_days; $i++): ?>
              ...
              <td class="text-center" <?= ($weekday == 7) ? "style=\"background-color: #ff000011;\"" : "" ?>>
                ...
                <?php if($status == 1){ ?>
                  ...
                  <a class="mdi mdi-checkbox-marked-outline" onclick="rightModal('<?php echo site_url('modal/popup/attendance/confirm/'.$attendance['id'])?>', '<?= get_phrase('attendance_confirm'); ?>')" data-toggle="tooltip" data-placement="top" title=""></a>
                <?php }elseif($status === "2"){ ?>
