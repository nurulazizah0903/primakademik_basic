...
<form method="POST" class="d-block ajaxForm" action="<?php echo route('means/update/'.$param1); ?>">
    <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <textarea name="status" class="form-control" id="status" cols="3" rows="3"><?=$means_details['status'];?></textarea>
        </div>
        ...
        <div class="form-group col-md-12">
            ...
            <select name="location_id" id="location_id" class="form-control select2" data-toggle = "select2" required>
                ...
                foreach ($locations as $location): ?>
                    <option value="<?php echo $location['id']; ?>" <?php if ($means_details['location_id'] == $location['id']): ?> selected <?php endif; ?>><?php echo $location['name']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
