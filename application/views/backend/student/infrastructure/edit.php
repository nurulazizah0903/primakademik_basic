    ...
    <div class="form-group col-md-12">
        ...
        <div class="form-group col-md-12">
            ...
            <select name="status" id="status" class="form-control select2" data-toggle = "select2">
                ...
                <option value="terpakai" <?php if ($infrastructure_details['status'] == 'terpakai'): ?> selected <?php endif; ?>><?php echo get_phrase('use'); ?></option>
                <option value="tidak terpakai" <?php if ($infrastructure_details['status'] == 'tidak terpakai'): ?> selected <?php endif; ?>><?php echo get_phrase('not_use'); ?></option>
            </select>
        </div>
