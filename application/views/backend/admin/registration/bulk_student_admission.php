        ...
        <div class="row">
            <div class="col-xl-11 col-lg-11 col-md-12 col-sm-12 mb-3 mb-lg-0">
                <div class="row justify-content-md-center">
                    ...
                    <div class="form-group col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-1 mb-lg-0">
                        <input readonly type="text" name="email_siswa[]" class="form-control"  value="" placeholder="<?php echo get_phrase('email'); ?>" required>
                    </div>
                    <div class="form-group col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-1 mb-lg-0">
                        <input readonly type="text" name="nisn[]" class="form-control"  value="" placeholder="<?php echo get_phrase('nisn'); ?>" required>
                    </div>
                </div>
            </div>
...
function grabPpdb(id, e) {
    ...
    var inputEmail = $(e).parent().siblings().find('input[name="email_siswa[]"]');
    var inputNisn = $(e).parent().siblings().find('input[name="nisn[]"]');
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            inputEmail.val(data.email_siswa);
