      ...
      <div class="row justify-content-left">
        <div class="col-12">
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <input type="text" id="bank_name" name="bank_name" class="form-control"  value="<?php echo get_frontend_settings('bank_name') ;?>" required>
            </div>
          </div>

          <div class="form-group row mb-3">
            <label class="col-md-3 col-form-label" for="account_name"> <?php echo get_phrase('account_name') ;?></label>
            <div class="col-md-9">
              <input type="text" id="account_name" name="account_name" class="form-control"  value="<?php echo get_frontend_settings('account_name') ;?>" required>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <input type="number" id="account_number" name="account_number" class="form-control"  value="<?php echo get_frontend_settings('account_number') ;?>" required>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-9">
              <input type="text" id="total" name="total" class="form-control"  value="<?php echo get_frontend_settings('total') ;?>" required>
            </div>
          </div>
