        ...
        <div class="row">
            <div class="col-lg-6 ">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_un'); ?></h5>
                        <input type="text" id="nomor_un" name="nomor_un" class="form-control" placeholder="<?php echo get_phrase('nomor_un'); ?>">
        ...
        <div class="row">
            <div class="col-lg-6 ">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_ijazah'); ?> </h5>
                    <input type="text" id="nomor_ijazah" name="nomor_ijazah" class="form-control" placeholder="<?php echo get_phrase('nomor_ijazah'); ?>" >
                
            </div> <!-- end col-->

            <div class="col-lg-6 ">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('nomor_skhun'); ?></h5>
                    <input type="text" id="nomor_skhun" name="nomor_skhun" class="form-control" placeholder="<?php echo get_phrase('nomor_skhun'); ?>">
        ...
        <div class="row">
            <div class="col-lg-6 ">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('school_before'); ?> </h5>
                    <input type="text" id="school_before" name="school_before" class="form-control" placeholder="<?php echo get_phrase('school_before'); ?>">
                
            </div> <!-- end col-->
            <div class="col-lg-6 ">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('NIS'); ?> <font style="color:red;">*</font></h5>
                    <input type="text" id="nis" name="nis" class="form-control" placeholder="<?php echo get_phrase('NIS'); ?>" required>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('blood_group'); ?> </h5>
                            <select name="student_blood_group" id="student_blood_group" class="form-control select2" data-toggle = "select2" >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('phone'); ?> </h5>
                            <input type="text" id="student_phone" name="student_phone" class="form-control" placeholder="phone" >
                    </div> <!-- end col-->
                </div> <!-- end row --><br>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('province'); ?> </h5>
                            <select name="student_province_id" id="student_province_id" class="form-control select2" data-toggle = "select2" onchange="districtWiseSectionStudent(this.value)">
                    ...
                    <div class="col-lg-3">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('district'); ?> </h5>
                            <select name="student_district_id" id="student_district_id" class="form-control select2" data-toggle = "select2" onchange="districtsWiseSectionStudent(this.value)">
                    ...
                    <div class="col-lg-3">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('districts'); ?> </h5>
                            <select name="student_districts_id" id="student_districts_id" class="form-control select2" data-toggle = "select2" onchange="wardWiseSectionStudent(this.value), postcodeWiseSectionStudent(this.value)">
                    ...
                    <div class="col-lg-3">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('ward'); ?> </h5>
                            <select name="student_ward_id" id="student_ward_id" class="form-control select2" data-toggle = "select2">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('address'); ?> <font style="color:red;">*</font></h5>
                            <textarea class="form-control" id="example-textarea" rows="5" name = "student_address" placeholder="address" required></textarea>
                    </div> <!-- end col-->

                    <div class="col-lg-4">
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('postcode'); ?> </h5>
                            <select name="student_postcode_id" id="student_postcode_id" class="form-control select2" data-toggle = "select2">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('traveling_time'); ?> </h5>
                                <input type="text" id="traveling_time" name="traveling_time" class="form-control" placeholder="traveling_time" >
                            </div><br><br><br>
                    </div>
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('child_of'); ?> </h5>
                                <input type="text" id="child_of" name="child_of" class="form-control" placeholder="child_of" >
                            </div><br><br><br>
                    </div>
                    <div class="row">
                    <div class="col-lg-9">
                        <h5 style="font-weight: bold;"><?php echo get_phrase('number_of_siblings'); ?> </h5>
                                <input type="text" id="number_of_siblings" name="number_of_siblings" class="form-control" placeholder="number_of_siblings" >
                            </div><br><br>
                    </div>
                    </div>
