...
class Superadmin extends CI_Controller {
  ...
  public function dashboard(){
    ...
    // $querydb2 = $db2->select('*')->get('users'); // tampil data DB2 table admin
    // $user2 = $querydb2->result_array();
    // $page_data['user2'] = $user2;
  ...
  public function section($action = "", $id = "", $exclude = "") {
    ...
    if ($action == 'list') {
	 ...
	 if ($action == 'list_finance') {
      $page_data['class_id'] = $id;
      $page_data['exclude'] = $exclude;
      $this->load->view('backend/superadmin/section/dropdown_finance', $page_data);
    } 
    ...
    // if($param1 == 'update'){
    //   $response = $this->crud_model->section_update_one($param2);
    //   echo $response;
    // }
    ...
    //   $this->load->view('backend/superadmin/section/list_all', $page_data);
    // }

    // if($param1 == 'list_all'){
    //   $this->load->view('backend/superadmin/section/list_all');
    // }
  ...
  public function district_dropdown($action = "", $province_id = "", $user_id = "") {
    ...
    if ($action == 'dropdown') {
      ...
      $this->load->view('backend/superadmin/district/dropdown', $page_data);
    }

    if ($action == 'edit') {
      $page_data['user_id'] = $user_id;
      $this->load->view('backend/superadmin/district/dropdown_edit', $page_data);
    }
  }
  //	district ENDED
  ...
  public function districts_dropdown($action = "", $district_id = "") {
    ...
    if ($action == 'dropdown') {
      ...
      $this->load->view('backend/superadmin/districts/dropdown', $page_data);
    }
  }
  //	districts ENDED
  ...
  public function ward_dropdown($action = "", $districts_id = "") {
    ...
    if ($action == 'dropdown') {
      ...
      $this->load->view('backend/superadmin/ward/dropdown', $page_data);
    }
  }
  //	ward ENDED
  ...
  public function postcode_dropdown($action = "", $districts_id = "") {
    ...
    if ($action == 'dropdown') {
      $page_data['districts_id'] = $districts_id;
      $this->load->view('backend/superadmin/postcode/dropdown', $page_data);
    }
  }
  //	postcode ENDED
  ...
  public function class_room($param1 = '', $param2 = '', $param3 = ''){
    ...
    if ($param1 == 'dropdown') {
      ...
      $this->load->view('backend/superadmin/class_room/dropdown', $page_data);
    }
  ...
  public function student_extracurricular($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = ''){
    ...
    if ($param1 == 'filter') {
      ...
      $this->load->view('backend/superadmin/student_extracurricular/list', $page_data);
    }

    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/student_extracurricular/list');
    }
  ...
  public function extracurricular_participants($param1 = '', $param2 = '', $param3 = ''){
    ...
    if ($param1 == 'filter') {
      ...
      $this->load->view('backend/superadmin/extracurricular_participants/list', $page_data);
    }

    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/extracurricular_participants/list');
    }
  ...
  public function organizations($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/organizations/list');
    }
  ...
  public function subject($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/subject/list');
    }
  ...
  public function knowledge_base($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      ...
      $this->load->view('backend/superadmin/knowledge_base/list', $page_data);
    }
  ...
  public function subject_wise_base($action = "", $subject_id = "") {
		...
		if ($action == 'list') {
			...
			$this->load->view('backend/superadmin/knowledge_base/dropdown', $page_data);
		}
	  }
  ...
  //START EMPLOYEE_STATUS section
   public function employee_status($param1 = '', $param2 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/employee_status/list');
    }
  ...
  public function operational_hour($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->operational_hour_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->operational_hour_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->operational_hour_delete($param2);
      echo $response;
    }

    // Get the data from database
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/operational_hour/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'operational_hour';
      $page_data['page_title'] = 'operational_hour';
      $this->load->view('backend/index', $page_data);
    }
  }
  ...
  public function registration_path($param1 = '', $param2 = ''){

    if($param1 == 'create'){
      $response = $this->crud_model->registration_path_create();
      echo $response;
    }

    if($param1 == 'update'){
      $response = $this->crud_model->registration_path_update($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->registration_path_delete($param2);
      echo $response;
    }

    // Get the data from database
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/registration_path/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'registration_path';
      $page_data['page_title'] = 'registration_path';
      $this->load->view('backend/index', $page_data);
    }
  }
  //END OPERATIONAL_HOUR section
  ...
  public function syllabus($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/syllabus/list');
    }
	...
	public function materials($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = ''){
      ...
      $page_data['room_id'] = $this->input->post('room_id');
		  $page_data['subject_id'] = $this->input->post('subject_id');
			$this->load->view('backend/superadmin/materials/list', $page_data);
		}

    if($param1 == 'list'){
			$this->load->view('backend/superadmin/materials/list');
		}
  ...
  //START QUESTION BANK section
    ...
    if($param1 == 'excel_question'){
		...
		if($param1 == 'list'){
			$this->load->view('backend/superadmin/question_bank/list');
		}

		if($param1 == 'filter'){
			$page_data['subject_id'] = $this->input->post('subject_id');
			$this->load->view('backend/superadmin/question_bank/list', $page_data);
		}
  ...
  public function employee_mutation($param1 = "", $param2 = "", $param3 = "") {
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/employee_mutation/list');
    }
  ...
  public function teacher($param1 = '', $param2 = '', $param3 = ''){
    ...
    //       $sheet->setCellValue('B1', 'Panggilan');
    ...
    //           $sheet->setCellValue('A' . $rows, $this->user_model->get_user_details($teacher['user_id'], 'name'));
    //           $sheet->setCellValue('B' . $rows, $val['designation']);
    //           $sheet->setCellValue('C' . $rows, $this->user_model->get_user_details($teacher['user_id'], 'address'));
    //           $sheet->setCellValue('D' . $rows, $this->user_model->get_user_details($teacher['user_id'], 'phone'));
  ...
  public function exam_mark($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      ...
      $this->load->view('backend/superadmin/exam_mark/list', $page_data);
    }
  ...
  public function assignment_mark($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      ...
      $this->load->view('backend/superadmin/assignment_mark/list', $page_data);
    }
  ...
  public function homeroom($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/homeroom/list');
    }
  ...
  public function guardian($param1 = '', $param2 = ''){
    ...
    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/guardian/list');
    }
  ...
  public function other_employee($param1 = '', $param2 = ''){
    ...
    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/other_employee/list');
    }
  ...
  public function routine($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/routine/list');
    }
  ...
  public function routine_extracurricular($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $this->load->view('backend/superadmin/routine_extracurricular/list', $page_data);
    }
  ...
  public function attendance_report($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $this->load->view('backend/superadmin/attendance_report/list', $page_data);
    }

    if($param1 == 'list'){
      $this->load->view('backend/superadmin/attendance_report/list');
    }
  ...
  public function attendance($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'filter'){
      $date = '01 '.$this->input->post('month').' '.$this->input->post('year');
      $page_data['attendance_date'] = strtotime($date);
      $class_room = $this->input->post('class_id');
      $class_rooms = $this->db->get_where('class_rooms', array('id' => $class_room))->row_array();
      $sections = $this->db->get_where('sections', array('id' => $class_rooms['section_id']))->row_array();
      $page_data['class_id'] = $sections['class_id'];
      $page_data['section_id'] = $class_rooms['section_id'];
      $page_data['month'] = $this->input->post('month');
      $page_data['year'] = $this->input->post('year');
  ...
  public function attendance_routine($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = ''){
    ...
    if($param1 == 'filter'){
      $date = '01 '.$this->input->post('month').' '.$this->input->post('year');
      $page_data['attendance_date'] = strtotime($date);
      $subject_id = $this->input->post('class_id');
      $subjects = $this->db->get_where('subjects', array('id' => $subject_id))->row_array();
      $page_data['class_id'] = $subjects['class_id'];
      $page_data['section_id'] = $subjects['section_id'];
      $page_data['subject_id'] = $subject_id;
      $page_data['month'] = $this->input->post('month');
      $page_data['year'] = $this->input->post('year');
      $this->load->view('backend/superadmin/attendance_routine/list', $page_data);
    }
    ...
    if($param1 == 'student'){
      ...
      $page_data['subject_id'] = $this->input->post('subject_id');
      $page_data['room_id'] = $this->input->post('room_id');
      $this->load->view('backend/superadmin/attendance_routine/student', $page_data);
    }
  ...
  public function attendance_employee($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $this->load->view('backend/superadmin/attendance_employee/list', $page_data);
    }
    ...
    if($param1 == 'employee'){
      $page_data['attendance_date'] = strtotime($this->input->post('date'));
      $page_data['role'] = $this->input->post('role');
      $this->load->view('backend/superadmin/attendance_employee/employee', $page_data);
    }
  ...
  public function attendance_teacher($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $page_data['month'] = $this->input->post('month');
      $page_data['year'] = $this->input->post('year');
      $this->load->view('backend/superadmin/attendance_teacher/list', $page_data);
    }

    if($param1 == 'teacher'){
      $page_data['attendance_date'] = strtotime($this->input->post('date'));
      $this->load->view('backend/superadmin/attendance_teacher/teacher', $page_data);
    }
  ...
  public function attendance_librarian($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $page_data['month'] = $this->input->post('month');
      $page_data['year'] = $this->input->post('year');
      $this->load->view('backend/superadmin/attendance_librarian/list', $page_data);
    }

    if($param1 == 'librarian'){
      $page_data['attendance_date'] = strtotime($this->input->post('date'));
      $this->load->view('backend/superadmin/attendance_librarian/librarian', $page_data);
    }
  ...
  public function attendance_accountant($param1 = '', $param2 = '', $param3 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $page_data['month'] = $this->input->post('month');
      $page_data['year'] = $this->input->post('year');
      $this->load->view('backend/superadmin/attendance_accountant/list', $page_data);
    }

    if($param1 == 'accountant'){
      $page_data['attendance_date'] = strtotime($this->input->post('date'));
      $this->load->view('backend/superadmin/attendance_accountant/accountant', $page_data);
    }
  ...
  public function awards($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/awards/list');
    }
  ...
  public function achievements($param1 = '', $param2 = ''){
    ...
    // Get the data from database
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/achievements/list');
    }
  ...
  public function mistakes($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/mistakes/list');
    }
  ...
  if ($param1 == 'create_routine') {
   ...
   if($param1 == 'create'){
    ...
    // Get the data from database
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/violations/list');
    }
  ...
  public function announcement($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/announcement/list');
    }
  ...
  public function registration($action = '', $param2 = '', $param3 = '') {
    ...
    if ($action == 'pay') {
      ...
      if (!empty($v_satu)) {
        ...
        $history_data['ket'] = 'Mengisi data payment_ppdb';
        $history_data['id_user'] = $this->session->set_userdata('user_id');
        $this->db->insert('history', $history_data);
      }
      if(!empty($v_dua)){
    ...
    if ($action == 'update_status') {
      ...
      $this->session->set_flashdata('flash_message', get_phrase('updated_successfully'));
      redirect(site_url('superadmin/registration/create/'.$param2), 'refresh');
    }
    ...
    if($action == 'get_admitted_students_list') {
      return $this->load->view('backend/superadmin/registration/student_list');
    }

    if($action == 'refresh_bulk_student_admission') {
      return $this->load->view('backend/superadmin/registration/bulk_student_admission');
    }
    ...
    if($action == 'list') {
      ...
      $this->load->view('backend/superadmin/registration/list', $page_data);
    }
  ...
  public function student($param1 = '', $param2 = '', $param3 = '', $param4 = '', $param5 = '', $param6 = '', $param7 = ''){
    ...
    if($param1 == 'upload_excel_student'){
      $response = $this->crud_model->import();
      echo $response;
    }
    ...
    if ($param1 == 'manage_alocation_student') {
      $this->load->view('backend/superadmin/student/manage_student');
    }
    ...
    if($param1 == 'list_move'){
      $this->load->view('backend/superadmin/student/list_move');
    }
    ...
    if($param1 == 'filter_move'){
      $page_data['class_id'] = $this->input->post('class_id');
		  $page_data['section_id'] = $this->input->post('section_id');
      $page_data['room_id'] = $this->input->post('room_id');
      $this->load->view('backend/superadmin/student/list_move', $page_data);
    }

    if($param1 == 'stundent_card_bulk'){
      $page_data['room_id'] = $this->input->post('room_id');
      $page_data['desain'] = $this->input->post('desain');
      $this->load->view('backend/superadmin/student/print_card_bulk', $page_data);
    }
  ...
  public function student_info($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'student_info'){
      $page_data['student_id'] = $param2;
      $this->load->view('backend/superadmin/student_info/student_info', $page_data);
    }
  ...
  public function employee_info($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'employee_info'){
      ...
      $this->load->view('backend/superadmin/employee_info/employee_info', $page_data);
    }
  ...
  public function student_routine($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'filter'){
      $page_data['class_id'] = $this->input->post('class_id');
		  $page_data['section_id'] = $this->input->post('section_id');
      $page_data['room_id'] = $this->input->post('room_id');
      $this->load->view('backend/superadmin/student_routine/list', $page_data);
    }

    if($param1 == 'list'){
      $this->load->view('backend/superadmin/student_routine/list');
    }
  ...
  public function marks_archives($param1 = '', $param2 = ''){
    ...
    if($param1 == 'list'){
      ...
      $this->load->view('backend/superadmin/marks_archives/list', $page_data);
    }
  ...
  public function finance2($param1 = "", $param2 = "", $param3 = '') {
    ...
    if ($param1 == 'list') {
      $page_data['class_id'] = $param2;
      $page_data['section_id'] = $param3;
      $this->load->view('backend/superadmin/finance/list', $page_data);
    }
  ...
  public function semester($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/semester/list');
    }
  ...
  public function exam_types($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/exam_types/list');
    }
  ...
  public function assignment_types($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/assignment_types/list');
    }
  ...
  public function ward($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/ward/list');
    }
  ...
  public function district($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/district/list');
    }
  ...
  public function districts($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/districts/list');
    }
  ...
  public function postcode($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/postcode/list');
    }
  ...
  public function province($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/province/list');
    }
  ...
  public function years($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/year/list');
    }
  ...
  public function book_types($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/book_type/list');
    }
  ...
  public function locations($param1 = '', $param2 = ''){
    ...
    if($param1 == 'create'){
      $response = $this->crud_model->create_locations();
      echo $response;
    }

    if($param1 == 'edit'){
      $response = $this->crud_model->update_locations($param2);
      echo $response;
    }

    if($param1 == 'delete'){
      $response = $this->crud_model->delete_locations($param2);
      echo $response;
    }

    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/location/list');
    }

    if(empty($param1)){
      $page_data['folder_name'] = 'location';
  ...
  public function book_issue($param1 = "", $param2 = "", $param3 = "", $param4 = "") {
    ...
    if ($param1 == 'role') {
      ...
      $this->load->view('backend/superadmin/book_issue/role', $page_data);
    }
  ...
  public function routine_counseling($param1 = "", $param2 = "", $param3 = '', $param4 = '') {
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/routine_counseling/list');
    }

    if($param1 == 'filter'){
      $page_data['class_id'] = $this->input->post('class_id');
		  $page_data['section_id'] = $this->input->post('section_id');
      $this->load->view('backend/superadmin/routine_counseling/list', $page_data);
    }
  ...
  //JOB FAIR LIST MANAGER START
  public function job_fair($param1 = "", $param2 = "") {
    // adding job_fair
    if ($param1 == 'create') {
      $response = $this->crud_model->create_job_fair();
      echo $response;
    }

    // update job_fair
    if ($param1 == 'update') {
      $response = $this->crud_model->update_job_fair($param2);
      echo $response;
    }

    // deleting job_fair
    if ($param1 == 'delete') {
      $response = $this->crud_model->delete_job_fair($param2);
      echo $response;
    }
    // showing the list of job_fair
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/job_fair/list');
    }

    // showing the index file
    if(empty($param1)){
      $page_data['folder_name'] = 'job_fair';
      $page_data['page_title']  = 'job_fair';
      $this->load->view('backend/index', $page_data);
    }
  }
  //JOB FAIR LIST MANAGER FINISH
  ...
  public function visit_data($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'role') {
      $page_data['role'] = $param2;
      $this->load->view('backend/superadmin/visit_data/role', $page_data);
    }
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/visit_data/list');
    }
  ...
  public function system_settings($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'cover_update') {
      $response = $this->settings_model->update_cover_photo();
      echo $response;
    }
   ...
   public function menu_settings($param1 = "", $param2 = "") {
    if($param1 == 'modify_menu_settings'){
      ...
      echo $response;
      // $this->user_model->teacher_permission();
      $this->load->view('backend/superadmin/settings/menu_settings');
    }
  ...
  //Raport section
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/raport/list');
    }
  ...
  public function finance_odoo($param1 = "", $param2 = "", $param3 = '') {
    ...
    if ($param1 == 'list') {
      ...
      $this->load->view('backend/superadmin/finance_odoo/list', $page_data);
    }
  ...
  public function infrastructure($param1 = "", $param2 = "") {
    ...
    if($param1 == 'filter_list'){
      $page_data['location_id'] = $this->input->post('location_id');
			$this->load->view('backend/superadmin/infrastructure/list', $page_data);
		}
  ...
  public function infrastructure_issue($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'role') {
      $page_data['role'] = $param2;
      $this->load->view('backend/superadmin/infrastructure_issue/role', $page_data);
    }
    ...
    if($param1 == 'filter_list'){
      $page_data['infrastructure_id'] = $this->input->post('infrastructure_id');
		  $page_data['date'] = $this->input->post('date');
			$this->load->view('backend/superadmin/infrastructure_issue/list', $page_data);
		}
    ...
    if($param1 == 'filter_issue'){
      $page_data['infrastructure_id'] = $this->input->post('infrastructure_id');
		  $page_data['date'] = $this->input->post('date');
			$this->load->view('backend/superadmin/infrastructure_issue/list_issue', $page_data);
		}
  ...
  public function means($param1 = "", $param2 = "") {
    ...
    if($param1 == 'filter_list'){
      $page_data['location_id'] = $this->input->post('location_id');
			$this->load->view('backend/superadmin/means/list', $page_data);
		}
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/means/list');
    }
  ...
  public function mean_issue($param1 = "", $param2 = "", $param3 = "", $param4 = "") {
    ...
    if ($param1 == 'role') {
      $page_data['role'] = $param2;
      $this->load->view('backend/superadmin/mean_issue/role', $page_data);
    }
    ...
    if($param1 == 'filter_list'){
      ...
      $page_data['tgl'] = $this->input->post('tgl');
			$this->load->view('backend/superadmin/mean_issue/list', $page_data);
		}
    ...
    if($param1 == 'filter_deadline'){
      $page_data['mean_id'] = $this->input->post('mean_id');
		  $page_data['date'] = $this->input->post('date');
      $page_data['tgl'] = $this->input->post('tgl');
			$this->load->view('backend/superadmin/mean_issue/list_deadline', $page_data);
		}
    ...
    if($param1 == 'filter_issue'){
      $page_data['mean_id'] = $this->input->post('mean_id');
		  $page_data['date'] = $this->input->post('date');
      $page_data['tgl'] = $this->input->post('tgl');
			$this->load->view('backend/superadmin/mean_issue/list_issue', $page_data);
		}
  ...
  public function employee($param1 = "", $param2 = "", $param3 = "") {
    ...
    if($param1 == 'edit'){
      $page_data['employee_id'] = $param2;
      // $page_data['working_page'] = 'edit';
      $page_data['folder_name'] = 'employee';
      $page_data['page_title'] = 'update_employee_information';
      $page_data['page_name'] = 'update';
      $this->load->view('backend/index', $page_data);
    }

    if($param1 == 'update_employee'){
      $response = $this->user_model->update_employee($param2);
      echo $response;
    }

    if($param1 == 'employee_card_bulk'){
      $this->load->view('backend/superadmin/employee/print_card_bulk', $page_data);
    }

    if ($param1 == 'reset_password') {
      $response = $this->crud_model->reset_employee_employee();
      echo $response;
    }

    if ($param1 == 'reset_password_by_id') {
      $response = $this->crud_model->reset_employee_password_by_id($param2);
      echo $response;
    }
    ...
    if($param1 == 'filter'){
      $page_data['role'] = $this->input->post('role');
      $this->load->view('backend/superadmin/employee/list', $page_data);
    }

    // showing the list of employee
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/employee/list');
    }
  ...
  public function job_management($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'role') {
      $page_data['role'] = $param2;
      $this->load->view('backend/superadmin/job_management/role', $page_data);
    }

    if ($param1 == 'detail') {
      $page_data['user_id'] = $param2;
      $this->load->view('backend/superadmin/job_management/detail', $page_data);
    }

    if ($param1 == 'detail_role') {
      $page_data['user_id'] = $param2;
      $this->load->view('backend/superadmin/job_management/detail_role', $page_data);
    }

    // PROVIDE A LIST OF SECTION ACCORDING TO CLASS ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/job_management/list');
    }
  ...
  public function payment_type($param1 = '', $param2 = ''){
    ...
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/payment_type/list');
    }
   ...
   public function account($param1 = '', $param2 = ''){
    ...
    // PROVIDE A LIST OF SECTION ACCORDING TO PAYMENT_TYPE ID
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/account/list');
    }
  ...
  public function invoice($param1 = "", $param2 = "") { 
	...
	if ($param1 == 'student_finance') {
      $page_data['enrolments'] = $this->user_model->get_student_details_by_id('section', $param2);
      $this->load->view('backend/superadmin/student/dropdown_finance', $page_data);
    } 
    ...
    if ($param1 == 'month') {  	
		...
		$this->load->view('backend/superadmin/invoice/dropdown_month', $page_data);
    }
    ...
    if ($param1 == 'recurring') {  			
		...
		$this->load->view('backend/superadmin/invoice/dropdown_recurring', $page_data);
    }
  }
  ...
  public function finance($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'invoice') { 
      ...
      $this->load->view('backend/superadmin/finance/dropdown', $page_data);
    }  
  ...
  public function journal_in($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'list') {
      ...
      $page_data['selected_section'] = 'all';
      $page_data['selected_class2'] = 'all'; 
      $this->load->view('backend/superadmin/journal_in/list', $page_data);
    }
  ...
  public function journal_out($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'list') {
      ...
      $page_data['date_from'] = strtotime($date[0].' 00:00:00');
      $page_data['date_to']   = strtotime($date[1].' 23:59:59'); 
      $this->load->view('backend/superadmin/journal_out/list', $page_data);
    }
  ...
  public function partner_ledger($param1 = "", $param2 = "") {
    // showing the list of invoices
      ...
      $page_data['date_from']   = strtotime($first_day_of_month);
      $page_data['date_to']     = strtotime($last_day_of_month);
			$this->load->view('backend/superadmin/partner_ledger/list', $page_data);
		}
  ...
  public function export_data($param1 = '', $param2 = ''){
    ...
    if($param1 == 'filter'){
      ...
      $this->load->view('backend/superadmin/export_data/list', $page_data);
    }
  ...
  public function industry_company($param1 = '', $param2 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/industry_company/list');
    }
  ...
  public function internship($param1 = '', $param2 = '', $param3 = '', $param4 = ''){
    ...
    if($param1 == 'list'){
      $this->load->view('backend/superadmin/internship/list');
    }
    ...
    if($param1 == 'attendance_filter'){
      ...
      $this->load->view('backend/superadmin/internship_attendance/list', $page_data);
    }
  ...
  public function student_card($param1 = '', $param2 = '', $param3 = '', $param4 = '')
  {
    $page_data['student_id'] = $param1;
    $page_data['desain'] = $param2;
    $page_data['folder_name'] = 'student_card';
    $page_data['page_title'] = 'student_card';
    $this->load->view('backend/index', $page_data);    
  }

  public function print_student_card($param1 = '', $param2 = '', $param3 = '', $param4 = '')
  {
    $page_data['student_id'] = $param1;
    $page_data['desain'] = $param2;
    $this->load->view('backend/superadmin/student_card/print', $page_data);    
  }
  ...
  {
    $page_data['employee_id'] = $employee_id;
    $this->load->view('backend/superadmin/employee_card/print', $page_data);    
  }
