    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          ...
          <!-- <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="showAjaxModal('<?php echo site_url('modal/popup/attendance_employee/confirm_all'); ?>', '<?php echo get_phrase('attendance_confirm'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('attendance_confirm'); ?></button> -->
          <!-- <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="largeModal('<?php echo site_url('modal/popup/attendance_employee/take_attendance_employee'); ?>', '<?php echo get_phrase('take_attendance_employee'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('take_attendance_employee'); ?></button> -->
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
