<div class="row justify-content-center">
    <div class="col-xl-12 mb-4 text-center mt-3">
        <a href="javascript::void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/academy/section_add/'.$course['id']); ?>', '<?php echo get_phrase('tambah_sub_materi_pelajaran'); ?>')"><i class="mdi mdi-plus"></i> <?php echo get_phrase('tambah_sub_materi_pelajaran'); ?></a>
        <a href="javascript::void(0)" class="btn btn-outline-primary btn-rounded btn-sm ml-1" onclick="showAjaxModal('<?php echo site_url('modal/popup/academy/lesson_add/'.$course['id']); ?>', '<?php echo get_phrase('tambah_materi_pelajaran'); ?>')"><i class="mdi mdi-plus"></i> <?php echo get_phrase('tambah_materi_pelajaran'); ?></a>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="card bg-light text-seconday on-hover-action mb-3" id = "section-<?php echo $section['id']; ?>">
                    <div class="card-body">
                        <h5 class="card-title" class="mb-3 mnh-35"><span class="font-weight-light"><?php echo get_phrase('sub_materi_pelajaran').' '.++$key; ?></span>: <?php echo $section['title']; ?><br><br>
                            <div class="row justify-content-center alignToTitle float-right display-none" id = "widgets-of-section-<?php echo $section['id']; ?>">
                                ...
                                <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm ml-1" name="button" onclick="showAjaxModal('<?php echo site_url('modal/popup/academy/section_edit/'.$section['id'].'/'.$course['id']); ?>', '<?php echo get_phrase('update_sub_materi_pelajaran'); ?>')" ><i class="mdi mdi-pencil-outline"></i> <?php echo get_phrase('edit_sub_materi_pelajaran'); ?></button>

                                <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm ml-1" name="button" onclick="confirmModal('<?php echo site_url('addons/courses/course_sections/'.$course['id'].'/delete'.'/'.$section['id']); ?>', reloadEditCoursePage )"><i class="mdi mdi-window-close"></i> <?php echo get_phrase('hapus_sub_materi_pelajaran'); ?></button>
