        ...
        <div class="card">
            ...
            <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <?php $student = $this->db->get_where('students', array('user_id' => $profile_data['id']))->row_array(); ?> 
                        <h5 style="font-weight: bold;"> <?php echo get_phrase('number_va'); ?> </h5>
                            <input type="text" class="form-control" id="va" name="va" value="<?= $student['va'] ?>" disabled >
                    </div> <!-- end col-->
                </div> <!-- end row --><br>
