...
<div class="row">
  <div class="col-xl-2 col-lg-3 col-md-12 col-sm-12">
    ...
    <a href="<?php echo route('website_settings/new_flash'); ?>" class="btn <?php if ($page_content == 'new_flash'): ?> btn-dark <?php else: ?> btn-secondary <?php endif; ?> btn-rounded btn-block"><?php echo get_phrase('new_flash'); ?></a>
    <a href="<?php echo route('website_settings/superiority'); ?>" class="btn <?php if ($page_content == 'superiority'): ?> btn-dark <?php else: ?> btn-secondary <?php endif; ?> btn-rounded btn-block"><?php echo get_phrase('superiority'); ?></a>
    ...
    <a href="<?php echo route('website_settings/maps'); ?>" class="btn <?php if ($page_content == 'maps'): ?> btn-dark <?php else: ?> btn-secondary <?php endif; ?> btn-rounded btn-block"><?php echo get_phrase('maps'); ?></a>
...
function updateMapsSettings() {
  $(".updateMapsSettings").validate({});
  $(".updateMapsSettings").submit(function(e) {
    var form = $(this);
    ajaxSubmit(e, form, reload);
  });
}

function updateSuperioritySettings() {
  $(".updateSuperioritySettings").validate({});
  $(".updateSuperioritySettings").submit(function(e) {
    var form = $(this);
    ajaxSubmit(e, form, reload);
  });
}

function updateNewFlashSettings() {
  $(".updateNewFlashSettings").validate({});
  $(".updateNewFlashSettings").submit(function(e) {
    var form = $(this);
    ajaxSubmit(e, form, reload);
  });
}
...
function updateGallerySettings() {
  $(".updateGallerySettings").validate({});
  $(".updateGallerySettings").submit(function(e) {
    var form = $(this);
    ajaxSubmit(e, form, reload);
  });
}
