    ...
    <table id="example" class="table table-striped dt-responsive nowrap" width="100%">
        ...
        <tbody>
            <?php foreach ($visit_datas as $visit_data):
                ...
                <tr>
                    <td>
                        <?php echo $users_details['name']; ?><br> 
                    </td>
                    <td>
                        <?php 
                    ...
                    <td>
                        <?php echo $users_details['phone']; ?><br> 
                    </td>
                    <td>
                        <?php echo $users_details['address']; ?><br> 
                    </td>
                    <td>
                        <div class="dropdown text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item" onclick="rightModal('<?php echo site_url('modal/popup/visit_data/edit/'.$visit_data['id'])?>', '<?php echo get_phrase('update_visit_data_information'); ?>');"><?php echo get_phrase('edit'); ?></a>
                                <!-- item-->
