...
<center>
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo route('attendance_employee/take_attendance_employee'); ?>" style="min-width: 300px; max-width: 600px;">
                        ...
                        <td>
                            ...
                            <div class="custom-control custom-radio">
                                ...
                                <?php if($update_attendance->num_rows() > 0): ?>
                                    ...
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="1" class="present" <?php if($row->status == 1) echo 'checked'; ?> required> <?php echo get_phrase('present'); ?> 
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="2" class="permission" <?php if($row->status == 2) echo 'checked'; ?> required> <?php echo get_phrase('permission'); ?> 
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="3" class="sick" <?php if($row->status == 3) echo 'checked'; ?> required> <?php echo get_phrase('sick'); ?> 
                                ...
                                <?php else: ?>
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="1" class="present" checked required> <?php echo get_phrase('present'); ?> 
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="2" class="permission" required> <?php echo get_phrase('permission'); ?> 
                                    <input type="radio" id="" name="status-<?php echo $employee['id']; ?>" value="3" class="sick" required> <?php echo get_phrase('sick'); ?> 
