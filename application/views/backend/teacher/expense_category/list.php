                        ...
                        <td>
                            <div class="dropdown text-center">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item" onclick="showAjaxModal('<?php echo site_url('modal/popup/expense_category/edit/'.$expense_category['id'])?>', '<?php echo get_phrase('update_expense_category'); ?>');"><?php echo get_phrase('edit'); ?></a>
                                    <!-- item-->
