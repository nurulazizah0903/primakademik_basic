                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo site_url('login/validate_login'); ?>" method="post" id="loginForm">
                        <div class="form-group">
                            <label for="emailaddress"><?php echo get_phrase('username'); ?></label>
                            <input class="form-control" type="text" name="email" id="emailaddress" required="" placeholder="<?php echo get_phrase('enter_your_email'); ?>">
                        </div>
                        <div class="form-group">
                    ...
                    <form action="<?php echo site_url('login/retrieve_password'); ?>" method="post" id="forgotForm" style="display: none;">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" required="" id="forgotEmail" placeholder="Masukkan email anda">
                        </div>
                        <div class="form-group mb-0 text-center">
