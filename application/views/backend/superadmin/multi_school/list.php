    ...
    <table id="basic-datatable" class="table table-striped dt-responsive nowrap"  width="100%">
      <thead>
        <tr style="background-color: #313a46; color: #ababab;">
          ...
          <th><?php echo get_phrase('npsn'); ?></th>
          <th><?php echo get_phrase('nss'); ?></th>
            ...
            <td>
              <div class="dropdown text-center">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  <!-- item-->
                  <a href="javascript:void(0);" class="dropdown-item" onclick="showAjaxModal('<?php echo site_url('modal/popup/multi_school/edit/'.$school['id'])?>', '<?php echo get_phrase('update_school'); ?>');"><?php echo get_phrase('edit'); ?></a>
                  <!-- item-->
