        ...
        <div class="card">
            ...
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('nip'); ?> <font style="color:red;">*</font></h5>
                        <input type="text" id="nip" name="nip" class="form-control" value="<?= $profile_data['nip'] ?>" required>
                
            </div> <!-- end col-->

            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('npwp'); ?></h5>
                    <input type="text" id="npwp" name="npwp" class="form-control" value="<?= $profile_data['npwp'] ?>">
            ...
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('jabatan'); ?> <font style="color:red;">*</font></h5>
                    <select name="role" id="role" class="form-control select2" data-toggle = "select2"  required disabled>
                        ...
                        <option value="teacher" <?php if($profile_data['role'] == 'teacher') echo 'selected'; ?>><?php echo get_phrase('teacher'); ?></option>
                        <option value="accountant" <?php if($profile_data['role'] == 'accountant') echo 'selected'; ?>><?php echo get_phrase('accountant'); ?></option>
                        <option value="librarian" <?php if($profile_data['role'] == 'librarian') echo 'selected'; ?>><?php echo get_phrase('librarian'); ?></option>
                        <option value="admin" <?php if($profile_data['role'] == 'admin') echo 'selected'; ?>><?php echo get_phrase('admin'); ?></option>
                        <option value="other_employee" <?php if($profile_data['role'] == 'other_employee') echo 'selected'; ?>><?php echo get_phrase('other_employee'); ?></option>
                    </select>
            </div> <!-- end col-->
            ...
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('status'); ?> <font style="color:red;">*</font></h5>
                    <select name="status" id="status" class="form-control select2" data-toggle = "select2"  required>
                        ...
                        <option value="married" <?php if($profile_data['status'] == 'married') echo 'selected'; ?>><?php echo get_phrase('married'); ?></option>
                        <option value="not married yet" <?php if($profile_data['status'] == 'not married yet') echo 'selected'; ?>><?php echo get_phrase('not_married_yet'); ?></option>
                    </select>
            </div> <!-- end col-->
        </div> <!-- end row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('finish_date'); ?> <font style="color:red;">*</font></h5>
                    <input type="text" class="form-control" name = "finish_date" value="<?php echo get_phrase('sekarang'); ?>" disabled>
            </div> <!-- end col-->
        </div> <!-- end row --><br><br>
                ...
                <table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%">
                    ...
                    <?php foreach($job as $job_management):?>
                            <tr>
                                ...
                                <td><?php echo date('D, d/M/Y', strtotime($job_management['finish_date'])); ?></td>
                                <td>
