            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="page-title">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="showAjaxModal('<?php echo site_url('modal/popup/student/excel_student'); ?>', '<?php echo get_phrase('excel_upload'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('excel_upload'); ?></button>
                        <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="largeModal('<?php echo site_url('modal/popup/student/stundent_card_bulk'); ?>', '<?php echo get_phrase('stundent_card_bulk'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('stundent_card_bulk'); ?></button>
