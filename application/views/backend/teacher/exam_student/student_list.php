...
<div class="table-responsive-sm">
    <a href="<?php echo route('export_data/'.$exam_details['id'].'/'.$class_id.'/'.$section_id); ?>" class="btn btn-secondary buttons-excel buttons-html5 btn-info btn-md mb-4"><?php echo get_phrase('export to excel'); ?></a>
    <table id="basic-datatable" class="table table-light mb-0">
        ...
        <tbody>
            ...
            $student_exam = $this->db->get_where('exam_answers', array('exam_id' => $exam_details['id'], 'student_id' => $student['user_id'], 'status' => '1'));
            ?>
            <tr>
                ...
                <td class="text-center">
                    <?php if($student_exam->num_rows() > 0){ ?>
                ...
                <td class="text-center">
                    <a href="<?= site_url('addons/exam/answer_and_mark/'.$exam_details['id'].'/'.$student['user_id']); ?>" class="btn btn-outline-info btn-sm">
