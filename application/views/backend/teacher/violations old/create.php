...
<input type="hidden" name="school_id" value="<?php echo school_id(); ?>">
    ...
    <!-- <div class="form-group row mb-3">
        <label class="col-md-3 col-form-label" for="point"><?php echo get_phrase('point'); ?></label>
        <div class="col-md-9">
            <input type="text" class="form-control" id="point" name = "point" value="<?php echo $mistake['point']; ?>" required>
        </div>
    </div> -->
