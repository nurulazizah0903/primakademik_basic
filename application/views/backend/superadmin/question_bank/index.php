        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-rounded alignToTitle" onclick="largeModal('<?php echo site_url('modal/popup/question_bank/create'); ?>', '<?php echo get_phrase('create_question_bank'); ?>')"> <i class="mdi mdi-plus"></i> <?php echo get_phrase('add_question_bank'); ?></button>
