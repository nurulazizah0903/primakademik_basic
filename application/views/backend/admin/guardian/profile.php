<?php
    ...
    $guardians = $this->db->get_where('users', array('id' => $param1))->row_array();
    $guardians_id = $this->db->get_where('guardians', array('user_id' => $guardians['id']))->row_array();
    $student = $this->db->get_where('students', array('guardian_id' => $guardians_id['id']))->row_array();
    // var_dump($student);
    // die;
    ...
    <div class="row align-items-center h-100">
        <div class="col-md-4 pb-2">
            <div class="text-center">
                <img class="rounded-circle" width="50" height="50" src="<?php echo $this->user_model->get_user_image($guardians['user_id']); ?>">
                <br>
                <span style="font-weight: bold;">
                    <?php echo get_phrase('name'); ?>: <?php echo $guardians['name']; ?>
                </span>
            </div>
        </div>
        <div class="col-md-8">
            ...
            <table class="table table-centered mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= get_phrase($guardians['gender']) ?></td>
                        </tr>
                        <tr>
