                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <h5 style="font-weight: bold;"> <?php echo get_phrase('number_va'); ?> <font style="color:red;">*</font></h5>
                                    <input type="text" class="form-control" id="va" name="va" value="<?php echo $student['va']; ?>" placeholder="Virtual Account" required>
                            </div> <!-- end col-->
                        </div> <!-- end row --><br>
