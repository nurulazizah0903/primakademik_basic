<?php 
$school_id = school_id(); 
$users = $this->db->get_where('users', array('id' => $librarian_id))->result_array();
foreach($users as $user):
$job = $this->db->get_where('job_management', array('user_id' => $user['id']))->result_array();
$job_librarian = $this->db->get_where('job_management', array('user_id' => $librarian_id, 'status' => 1))->row_array();
?>
<!--title-->
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title">
                <i class="mdi mdi-update title_icon"></i> <?php echo get_phrase('librarian_update_form'); ?>
            </h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card pt-0">
            <h4 class="text-center mx-0 py-2 mt-0 mb-3 px-0 text-white bg-primary"><?php echo get_phrase('update_librarian_information'); ?></h4>
            <form method="POST" class="col-12 d-block ajaxForm" action="<?php echo route('librarian/update_employee/'.$librarian_id); ?>"  enctype="multipart/form-data">
            <div class="col-md-12">
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-6">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('start_date'); ?> <font style="color:red;">*</font></h5>
                    <input type="text" class="form-control" name = "start_date" value="<?php echo date('D, d/M/Y', strtotime($job_librarian['start_date'])); ?>" disabled>
            </div> <!-- end col-->
