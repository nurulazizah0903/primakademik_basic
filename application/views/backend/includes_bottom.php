...
<!-- Select2 JS -->
<script src="<?php echo base_url(); ?>assets/backend/js/vendor/select2.js"></script>
<script src="<?php echo base_url(); ?>assets/backend/js/vendor/select2.min.js"></script>

<!-- Datepicker JS -->
<script src="<?php echo base_url(); ?>assets/backend/js/vendor/bootstrap-datepicker.js"></script>
<script src="<?php echo base_url(); ?>assets/backend/js/vendor/bootstrap-datepicker.min.js"></script>

<!-- Daterangepicker JS -->
<script src="<?php echo base_url(); ?>assets/backend/js/vendor/daterangepicker.js"></script>
