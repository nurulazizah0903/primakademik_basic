			...
			<div class="col-md-8">
				<div class="row">
					<div class="col-md-12">
						...
						<a href="<?php echo route('invoice'); ?>" class="close-btn-light float-right"><i class="fa fa-times"></i></a>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col-md-8">
						...
						<div class="w-100 float-left mt-4 indicated-price">
							<div class="float-right total-price"><?php echo currency($total_amount_in_this_invoice); ?></div>
