                        ...
                        <table id="basic-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                            ...
                            <tbody>
                                <?php foreach ($courses as $key => $course):
                                    ...
                                    $section_details = $this->crud_model->get_sections($course['section_id'])->row_array();
                                    $class_room_details = $this->crud_model->get_class_room($course['room_id'])->row_array();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-info-lighten"><?php echo $section_details['name']; ?></span>
                                            <span class="badge badge-primary-lighten"><?php echo $class_room_details['name']; ?></span>
                                        </td>
                                        <td>
