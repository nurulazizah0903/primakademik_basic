                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" id="birthday_place" name="birthday_place" class="form-control" placeholder="<?php echo get_phrase('birthday_place'); ?>">
                        </div> <!-- end col-->
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <h5 style="font-weight: bold;"> <?php echo get_phrase('nisn'); ?></h5>
                                <input type="number" id="nisn" name="nisn" class="form-control" placeholder="<?php echo get_phrase('nisn'); ?>">                        
                        </div> <!-- end col-->
                        <div class="col-lg-6">
                            <h5 style="font-weight: bold;"> <?php echo get_phrase('sekolah_asal'); ?></h5>
                                <input type="text" id="sekolah_asal" name="sekolah_asal" class="form-control" placeholder="<?php echo get_phrase('school_before'); ?>">
                        </div> <!-- end col-->
                        <div class="col-lg-6">
