    ...
    <div class="card-body student_list">
        <div class="row justify-content-md-center" style="margin-bottom: 10px;">
            <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 mb-3 mb-lg-0">
                <a type="button" class="btn btn-icon btn-primary" href="<?php echo route('export_ppdb/'.'Not Yet Paid'); ?>"><?php echo get_phrase('export_data'); ?></a>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 mb-3 mb-lg-0">
                ...
                foreach($registrations as $item){ ?>
                    <tr><td>
                        ...
                        <td>
                            ...
                            <a href="javascript:void(0);" class="btn btn-success mdi mdi-note-text" onclick="largeModal('<?php echo site_url('modal/popup/registration/history_payment/'.$item['id']); ?>', '<?php echo get_phrase('history_pembayaran'); ?>')" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo get_phrase('history_pembayaran'); ?>"></a>
