<form method="POST" class="d-block ajaxForm" action="<?php echo route('frontend_gallery/create'); ?>" enctype="multipart/form-data">
  <div class="form-row">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text" class="form-control date" id="date_added" data-toggle="date-picker" data-single-date-picker="true" name = "date_added"   value="<?php echo date('m/d/Y'); ?>" required>
    </div>
