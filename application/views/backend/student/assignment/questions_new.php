        ...
        <div class="row d-flex flex-lg-row flex-column-reverse">
            ...
            <div class="col">
                <div
                    ...
                    <h1 class="ms-3 font-poppins font-size-sm-6 text-start">Tugas <br> Saya</h1>
                </div>
            </div>
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
            ...
            <a href="<?= site_url('addons/assignment/my_active_assignment'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"> <i class="mdi mdi-arrow-left"></i> <?php echo get_phrase('back_to_my_assignment'); ?></a>
        </h4>
      </div> <!-- end card body-->
    </div> <!-- end card -->
  </div><!-- end col-->
        ...
        <div class="row">
				...
				<div class="row">
					...
					<?php foreach($questions->result_array() as $key => $question):
						...
						<div class="col-md-12 bg-light border-bottom pb-2 mb-2">
							...
							<form action="<?php echo site_url('addons/assignment/save_answers'); ?>" method="POST" enctype="multipart/form-data" id="mainForm" name="mainForm">
			...
			<div class="col-md-4">
				...
				<div class="alert alert-primary" role="alert">
                    ...
                    <hr>
                    <strong><?php echo get_phrase('tenggat_waktu'); ?> :</strong> <?php echo date('d M Y', $assignment_details['deadline']); ?>
                </div>
			</div>
		</div>
    </div>
