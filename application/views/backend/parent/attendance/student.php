                    ...
                    <td>
                        ...
                        <div class="custom-control custom-radio">
                            ...
                            <?php else: ?>
                                ...
                                <input type="radio" id="" name="status-<?php echo $enroll['student_id']; ?>" value="2" class="present" required> <?php echo get_phrase('permission'); ?> <br/>
                                <input type="radio" id="" name="status-<?php echo $enroll['student_id']; ?>" value="3" class="present" required> <?php echo get_phrase('sick'); ?> <br/>
