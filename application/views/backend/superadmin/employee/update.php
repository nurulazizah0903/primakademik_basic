        ...
        <div class="row">
            ...
            <h5 style="font-weight: bold;"> <?php echo get_phrase('last_study'); ?> <font style="color:red;">*</font></h5>
                <select name="last_study" id="last_study" class="form-control select2" data-toggle = "select2">
                    ...
                    <option value="1" <?php if($job_employee['last_study'] == '1') echo 'selected'; ?>><?php echo get_phrase('SMA'); ?></option>
                    <option value="2" <?php if($job_employee['last_study'] == '2') echo 'selected'; ?>><?php echo get_phrase('S1'); ?></option>
                    <option value="3" <?php if($job_employee['last_study'] == '3') echo 'selected'; ?>><?php echo get_phrase('S2'); ?></option>
                </select>
            </div>
        </div> <!-- end row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('term_work'); ?></h5>
                    <input type="number" id="term_work" name="term_work" class="form-control" placeholder="Periode Jabatan" value="<?php echo $job_employee['term_work']; ?>">
            </div> <!-- end col-->
        </div> <!-- end row -->
            ...
            <div class="col-lg-3">
                <h5 style="font-weight: bold;"> <?php echo get_phrase('ptk_type'); ?></h5>
                    <select name="ptk_type" id="ptk_type" class="form-control select2" data-toggle = "select2">
                        ...
                        <option value="1" <?php if($job_employee['ptk_type'] == '1') echo 'selected'; ?>><?php echo get_phrase('Kepala Sekolah'); ?></option>
                        <option value="2" <?php if($job_employee['ptk_type'] == '2') echo 'selected'; ?>><?php echo get_phrase('Wakil Kepala Sekolah'); ?></option>
                        <option value="3" <?php if($job_employee['ptk_type'] == '3') echo 'selected'; ?>><?php echo get_phrase('Kepala TU'); ?></option>
                    </select>
                </div>
            <div class="col-lg-3">
