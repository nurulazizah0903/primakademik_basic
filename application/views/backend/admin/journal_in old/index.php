...
<div class="row ">
  <div class="col-xl-12">
    <div class="card">
      <div class="card-body">
        <h4 class="page-title">
          <i class="mdi mdi-database title_icon"></i> <?php echo get_phrase('Jurnal Masuk'); ?>
      ...
      <div class="card-body">
        <div class="row justify-content-md-center" style="margin-bottom: 10px;">
          ...
          <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 mb-3 mb-lg-0">
            <button type="button" class="btn btn-icon btn-secondary form-control" onclick="showAlljournal_in()"><?php echo get_phrase('filter'); ?></button>
          </div>

        </div>
        <div class="journal_in_content">
...
<script> 
var showAlljournal_in = function () {
  var url = '<?php echo route('journal_in/list'); ?>';
  $.ajax({
    type : 'GET',
    url: url,
    data : {date : $('#selectedValue').text()},
    success : function(response) {
      $('.journal_in_content').html(response);
