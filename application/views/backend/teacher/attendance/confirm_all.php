...
<form method="POST" class="d-block ajaxForm responsive_media_query" action="<?php echo route('attendance/confirm_all_student'); ?>" style="min-width: 300px; max-width: 400px;">
    <div class="form-group row">
        <div class="col-md-12">
            <label  for="class_id_on_taking_attendance"><?php echo get_phrase('select_section'); ?></label>
            <select name="permission_id" id="class_id_on_taking_attendance" class="form-control select2" data-toggle = "select2" required>
...
<script>
    ...
    $('document').ready(function(){
        initSelect2(['#class_id_on_taking_attendance', '#year_on_taking_attendance', '#month_on_taking_attendance']);
